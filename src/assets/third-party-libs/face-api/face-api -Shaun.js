...
function e(e,n){function r(){this.constructor=e;}t(e,n),e.prototype=null===n?Object.create(n):(r.prototype=n.prototype,new r);}
function n(t, e, n, r) {
...
function r(t,e){
          ...
          (function(){
              ...
              return r(this,(function(r){
                  switch(r.label){
                      case 0:
                          console.log('0');
                          return null==e&&(e={}),n=null==e.fetchFunc?i().platform.fetch:e.fetchFunc,o=manifest.map((function(manifest){return n(manifest,e.requestInit,{isBinary:!0})})),a=0,s=.5,null!=e.onProgress?[3,2]:[4,Promise.all(o)];
                      case 1:
                          console.log('1');
                          return u=r.sent(),[3,4];
                      case 2:
  ...
  loadWeights:function(manifest, modelBaseUri,o,a,alreadyLoadedWeightMapRaw){
      return 
        void 0===modelBaseUri&&(modelBaseUri=""),
        n(
            this,
            void 0,
            void 0,
            (function(){
                return r(this,(function(n){
                    return [2, Xf((function(t){return jf(t,{requestInit:a})}),alreadyLoadedWeightMapRaw)(manifest,modelBaseUri,o)]}))
            })
        )
    },
          ...
          return __generator(this, function (_b) {
              switch (_b.label) {
                  case 0:
                      ...
                      return [4 /*yield*/, alreadyLoadedManifest ? JSON.stringify(alreadyLoadedManifest) : fetchJson(manifestUri)];
                  case 1:
                      manifest = _b.sent();
