    ...
    return y(
        this,void 0,void 0,function(){
            ...
            return R(this,function(t){
                switch(t.label){
                    case 0:
                        console.log('hows about now boss hog...021?');
        ...
        y(
            ...
            function(){
                return R(
                    ...
                    function(t){
                        console.log('t: ' + t)
                        return[2, Nf( function(t){return Tf(t,{requestInit:o})} )(e,n,r) ]
                    })
            })
},
registerLoadRouter:function(t){return Xh.registerLoadRouter(t)},registerSaveRouter:function(t){return Xh.registerSaveRouter(t)},weightsLoaderFactory:Nf,withSaveHandler:function(t){return new Wf(t)},copyModel:function(e,n){return y(this,void 0,void 0,function(){return R(this,function(t){return[2,tf(e,n,!1)]})})},listModels:function(){
    return y(
        this,
        void 0,
        void 0,
        function(){
            ...
            return R(
                ...
                function(t){
                    switch(t.label){
                        case 0:
                            console.log('about to go from 0 to 1');
                            e=$h.getSchemes(),
                            n={},
                            r=0,
                            o=e,
                        ...
                        case 2:
                            for(s in a=t.sent())n[i+Yh+s]=a[s];t.label=3;
                        case 3:
                            return r++,[3,1];
                        case 4:
                            return[2,n]
...
var Bp=function(){return(Bp=Object.assign||function(t){for(var e,n=1,r=arguments.length;n<r;n++)for(var o in e=arguments[n])Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o]);return t}).apply(this,arguments)};
function Lp(i,a,s,u){
    console.log('too too  i: ' + i + ' a: ' + a + ' s: ' + s + ' u: ' + u)

    return new(s=s||Promise)(function(t,e){
        function n(t){
            console.log('t: '+ t)
            try{o(u.next(t))}catch(t){ console.log('expected catch?'); e(t)}
        }
        function r(t){
            try{o(u.throw(t))}catch(t){e(t)}
        }
        function o(e){
            e.done?t(e.value):new s(function(t){t(e.value)}).then(n,r)
        }
        o((u=u.apply(i,a||[])).next())
    })
}
function Wp(n,r){
    console.log('do du make it?');

    var o,i,a,t,s={
        label:0,
        sent:function(){
            console.log('is this t.sent...forrealz?');
            if(1&a[0])throw a[1];
            return a[1]
        },
        trys:[],
    ...
    return 
        ...
        "function"==typeof Symbol&&(t[Symbol.iterator]=function(){return this}),
        t;
    function e(e){
        console.log('kenny callum here');
        return function(t){
            console.log('kenny callum here 2');
            return function(e){
                console.log('kenny callum here 3');
                if(o)throw new TypeError("Generator is already executing.");
                for(;s;)
                    try{
                        if(o=1,i&&(a=2&e[0]?i.return:e[0]?i.throw||((a=i.return)&&a.call(i),0):i.next)&&!(a=a.call(i,e[1])).done)
                            return a;
                        switch(i=0,a&&(e=[2&e[0],a.value]),e[0]){
                            ...
                            case 5:s.label++,i=e[1],e=[0];continue;
                            case 7:e=s.ops.pop(),s.trys.pop();continue;
                            default:
        ...
        return Lp(
            ...
            function(){
                ...
                return Wp(this,function(t){
                    console.log('t.label: ' + t.label + ' n: ' + n + ' r: ' + r)
                    switch(t.label){
                        case 0:
                            // SHAUN used to be: return[4,(0,tv.getEnv().fetch)(n,r)];
                            return[4,alreadyLoaded];
                        case 1:
                            if(!alreadyLoaded) {
                                if(!((e=t.sent()).status<400))throw new Error("failed to fetch: ("+e.status+") "+e.statusText+", from url: "+e.url);
                                return[2,e]
                            } else {
                                return [2,alreadyLoaded]
                            }
                    }
                }
                )
...
function _v(e,alreadyLoaded){
    return Lp(
        ...
        function(){
            return Wp(this,function(t){
                return[2,alreadyLoaded] // SHAUN used to be:[2,t.sent().json()]                
            })
        }
    )
}
function Iv(t,e){
    ...
    if(!t)return{modelBaseUri:"",manifestUri:n};if("/"===t)return{modelBaseUri:"/",manifestUri:"/"+n};var r=t.startsWith("http://")?"http://":t.startsWith("https://")?"https://":"",o=(t=t.replace(r,"")).split("/").filter(function(t){return t}),i=t.endsWith(".json")?o[o.length-1]:n,a=r+(t.endsWith(".json")?o.slice(0,o.length-1):o).join("/");return{modelBaseUri:a=t.startsWith("/")?"/"+a:a,manifestUri:"/"===a?"/"+i:a+"/"+i}
}
function Rv(i,a,alreadyLoaded){ // i=uri, a=defultModelName, 
    return Lp(
        this,
        void 0,
        void 0,
        function(){
            ...
            return Wp(
                ...
                function(t){
                    switch(t.label){
                        case 0:return e=Iv(i,a),n=e.manifestUri,r=e.modelBaseUri,[4,_v(n,alreadyLoaded)];
                        case 1:return o=t.sent(),[2,Gf.loadWeights(o,r)]
                    }
                }
            )
        }
...
var kv=(Object.defineProperty(Sv.prototype,"params",{get:function(){return this._params},enumerable:!0,configurable:!0}),Object.defineProperty(Sv.prototype,"paramMappings",{get:function(){return this._paramMappings},enumerable:!0,configurable:!0}),Object.defineProperty(Sv.prototype,"isLoaded",{get:function(){return!!this.params},enumerable:!0,configurable:!0}),
Sv.prototype.getParamFromPath=function(t){var e=this.traversePropertyPath(t);return e.obj[e.objProp]},
Sv.prototype.reassignParamFromPath=function(t,e){var n=this.traversePropertyPath(t),r=n.obj,o=n.objProp;r[o].dispose(),r[o]=e},
Sv.prototype.getParamList=function(){var n=this;return this._paramMappings.map(function(t){var e=t.paramPath;return{path:e,tensor:n.getParamFromPath(e)}})},
Sv.prototype.getTrainableParams=function(){return this.getParamList().filter(function(t){return t.tensor instanceof Ft})},
Sv.prototype.getFrozenParams=function(){return this.getParamList().filter(function(t){return!(t.tensor instanceof Ft)})},
Sv.prototype.variable=function(){var r=this;this.getFrozenParams().forEach(function(t){var e=t.path,n=t.tensor;r.reassignParamFromPath(e,n.variable())})},
Sv.prototype.freeze=function(){var o=this;this.getTrainableParams().forEach(function(t){var e=t.path,n=t.tensor,r=In(n.dataSync());n.dispose(),o.reassignParamFromPath(e,r)})},
Sv.prototype.dispose=function(e){void 0===e&&(e=!0),this.getParamList().forEach(function(t){if(e&&t.tensor.isDisposed)throw new Error("param tensor has already been disposed for path "+t.path);t.tensor.dispose()}),this._params=void 0},Sv.prototype.serializeParams=function(){return new Float32Array(this.getParamList().map(function(t){var e=t.tensor;return Array.from(e.dataSync())}).reduce(function(t,e){return t.concat(e)}))},
Sv.prototype.load=function(e){return Lp(this,void 0,void 0,function(){return Wp(this,function(t){switch(t.label){case 0:return e instanceof Float32Array?(this.extractWeights(e),[2]):[4,this.loadFromUri(e)];case 1:return t.sent(),[2]}})})},
Sv.prototype.loadFromUri=function(n,alreadyLoaded,alreadyLoaded2){
    console.log('loadFromUri:'+n)
    _v(n,alreadyLoaded)
    //Rv(n,this.getDefaultModelName(),alreadyLoaded);
    /*
     return Lp(this,void 0,void 0,function(){ // this is u in : "o((u=u.apply(i,a||[])).next())"
         console.log('stickkens')
         var e;
         return Wp(this,function(t){
            console.log('popaloogi')
            switch(t.label){
                 case 0:
                     if(n&&"string"!=typeof n)
                        throw new Error(this._name+".loadFromUri - expected model uri");
                    return[4,Rv(n,this.getDefaultModelName(),alreadyLoaded)];
                 case 1:
                     //console.log('alreadyLoaded2: ' + alreadyLoaded2 + ' typeof t: ' + typeof t)
                     //SHAUN the following used to be: 
                     return e=t.sent(),this.loadFromWeightMap(e),[2]}}
                     //return e=alreadyLoaded2,this.loadFromWeightMap(e),[2]}}
            )
        }
     );
     */
...
Sv.prototype.loadFromDisk=function(h){
    console.log('we do make it in here')
    return Lp(
        this,
        void 0,
        void 0,
